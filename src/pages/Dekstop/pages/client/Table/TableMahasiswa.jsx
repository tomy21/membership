            ...
            <thead>
              <tr>
                <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                  <input type="checkbox" className="border border-slate-200" />
                </th>
                <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                  NIM
                </th>
                ...
                <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-center text-xs font-semibold text-gray-700 uppercase tracking-wider"></th>
              </tr>
            </thead>
            <tbody>
              {dataProduct.map((item, index) => (
                <tr key={item.id} className="text-start">
                  ...
                  <td className="px-5 py-3 border-b border-gray-200 bg-white text-xs text-center">
                    {item.CardStatus === "Approved" && (
                      <span className="text-green-400 border border-green-500 font-normal py-1 px-3 rounded-xl mr-2">
                        Approved
                      </span>
                    )}
                    {item.CardStatus === "New" && (
                      <span className="text-sky-400 border border-sky-500 font-normal py-1 px-3 rounded-xl mr-2">
                        New
                      </span>
                    )}
                    {item.CardStatus === "Reject" && (
                  ...
                  <td className="py-3 border-b border-gray-200 bg-white text-xs text-center">
                    <div className="flex flex-row justify-center items-center gap-x-3">
                      <RiCheckLine className="text-green-500 text-sm cursor-pointer" />
