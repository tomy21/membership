...
export default function AddMasterProduct({ isOpen, onClose, data, onSuccess }) {
    ...
    const calculateDates = (months, selectedMonth) => {
        ...
        setFormProduct({
            ...
            product_name: `${monthsDuration} Bulan`,
        });
    };
                        ...
                        <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                            <div className="flex flex-col justify-start">
                                ...
                                <p className="text-sm text-gray-400">
                                    Please fill out the form below to add a new
                                    product
                                </p>
                            </div>
                            <button
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            value={formatCurrency(
                                                formProduct.card_activation_fee
                                            )}
                                            onChange={handleCurrencyChange}
                                            className="w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                            required
